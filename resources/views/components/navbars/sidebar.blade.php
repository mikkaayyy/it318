...
<aside
    ...
    <div class="d-flex justify-content-center"> <!-- Center align content -->
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href="{{ route('dashboard') }}">
            <!-- <img src="{{ asset('assets') }}/img/hair.png" class="navbar-brand-img h-100" alt="main_logo"> -->
            <span class="font-weight-bold text-white">HAIR SALON APPOINTMENT SYSTEM</span>
        </a>
    </div>
</div>
